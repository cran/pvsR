...
##' @return A data frame with a row for each special interest group and columns with variables describing the rating. The returned data frame contains a row for each rating and columns with the following variables describing the rating:\cr sig.sigId,\cr sig.name,\cr rating*.ratingId,\cr rating*.timespan,\cr rating*.ratingName,\cr rating*.ratingText.
